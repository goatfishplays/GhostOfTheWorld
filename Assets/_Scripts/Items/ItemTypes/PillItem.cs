...
public class PillItem : ItemSO
{
    ...
    public PillItem(string itemName, string description = "no desc", bool consumeOnUse = true, Sprite sprite = null, float healAmount = 5, float toleranceAmount = 1f) : base(itemName, description, consumeOnUse, sprite)
    {
